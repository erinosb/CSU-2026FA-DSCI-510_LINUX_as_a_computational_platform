...
| August 27 | [Week1](01_modules/Week1) | Paths <br/> Options, Working with files 1 (more, less, head, tail, wc), Wildcards, Getting help | Chapter 2 (navigation), Chapter 3 (ls, less), Chapter 4 (wildcards) | [Assignment 2](https://github.com/erinosb/CSU-2026FA-DSCI-510_LINUX_as_a_computational_platform/blob/main/02_assignments/Assignment_2.md) **(due September 1)** |

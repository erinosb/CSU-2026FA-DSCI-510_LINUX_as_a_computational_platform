...
| September 8 | [Week3](01_modules/Week3) | Scripting <br/> Variables <br/> Array Variables | Chapter 20 (sed) <br/> Chapter 24 (scripting) <br/> Chapter 25 (variables) <br/> [Ryan's Tutorials - bash intro](https://ryanstutorials.net/bash-scripting-tutorial/bash-script.php) | [Assignment 3](02_assignments/Assignment_3.md) **(due September 15)** |
